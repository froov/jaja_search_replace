...
import {getNodeEndpoints} from "./find-replace-util"
import { Node } from "prosemirror-model"

window.ProseMirror = ProseMirror

//I think this defines the plugin so needs to be replaced with new Plugin
...
function findInNode(node:Node, findResult) {
  let ret = []
